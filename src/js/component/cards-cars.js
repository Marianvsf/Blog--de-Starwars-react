      ...
      <div className="overflow-x-auto" >
        ...
        {cars.map(car => (
          ...
          <div className="card-body">
            <img src={`https://starwars-visualguide.com/assets/img/vehicles/${car.uid}.jpg`} className="card-img-top" alt="..." />
            <h5 className="card-title">{car.name}</h5>
            <p className="card-text">Model: {car.model}</p>
            <p className="card-text">Cost in credits: {car.cost_in_credits}</p>
            <div className="d-flex justify-content-between">
            <Link to={car.url} className="btn btn-primary">Leer más...</Link>
